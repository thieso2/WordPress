...
# spec-id: PT-S005
# traceability:
#   screen: web.single (SCR-0131)
#   legacy_origin: wp-includes/template-loader.php -> single
...
Feature: Visual parity for web.single
  As the system
  ...
  Scenario: Rendered output matches the golden capture
    ...
    And a golden capture of "web.single" taken from the oracle
  ...
  Scenario: The capture is deterministic
    ...
    When "web.single" is captured twice
