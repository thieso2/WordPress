...
# spec-id: PT-S002
# traceability:
#   screen: web.front_page (SCR-0128)
#   legacy_origin: wp-includes/template-loader.php -> front_page
...
Feature: Visual parity for web.front_page
  As the system
  ...
  Scenario: Rendered output matches the golden capture
    ...
    And a golden capture of "web.front_page" taken from the oracle
  ...
  Scenario: The capture is deterministic
    ...
    When "web.front_page" is captured twice
