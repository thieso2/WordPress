...
# Helper that reads _reversa_sdd/ and returns JSON with the canonical sources the forward skills should consult as context.
# REVERSA differentiator: forward skills never start from scratch; they always anchor their reasoning in the reverse-pipeline artifacts.
#
# Usage:
...
#   without --for        Lists every file present in _reversa_sdd/
#
# Exit codes:
#   0 = success
