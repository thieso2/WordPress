...
#
# Standard output is single-line JSON. The agent reads it and acts on the fields.
# No external dependencies beyond bash; jq optional.
#
# Usage:
...
#   1 = at least one requirement is missing (details in the JSON)
#   2 = invalid usage
