...
# spec-id: PT-S004
# traceability:
#   screen: web.singular (SCR-0130)
#   legacy_origin: wp-includes/template-loader.php -> singular
...
Feature: Visual parity for web.singular
  As the system
  ...
  Scenario: Rendered output matches the golden capture
    ...
    And a golden capture of "web.singular" taken from the oracle
  ...
  Scenario: The capture is deterministic
    ...
    When "web.singular" is captured twice
