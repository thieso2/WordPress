...
# AUTO-GENERATED from the WordPress 7.2-alpha-63330 oracle. Do not edit by hand.
# Source: wp-includes/html-api/html5-named-character-references.php (a WP_Token_Map precomputed
# table), exported verbatim with WP_Token_Map::to_array(). Supports BR-MIGRATE-220 and
# BR-MIGRATE-223 by way of Markup::Decoder.
#
# All 2231 HTML5 named character references are present: semicolon-terminated and legacy
# (semicolon-less) forms alike. The HTML5 spec freezes this list, so it will never grow.
# Values are stored as raw UTF-8 byte escapes because the whole pack scans bytes, not characters.

module Markup
  module NamedCharacterReferences
    # Longest key in the table, in bytes; caps how far a lookup has to look ahead.
    MAX_LENGTH = 32
